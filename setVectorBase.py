...
LastEditTime: 2024-08-28 16:10:27
...
if __name__ == "__main__":
    k=6
    query = "我爱你"
    top_k_lines, top_k_timestamps, top_k_similarities,_= find_most_similar(query,k)
    # 打印查询结果
    for i in range(k):
        print(f"电影名：{3+4}相似度: {top_k_similarities[i]:.4f}\n时间轴: {top_k_timestamps[i]}\n台词: {top_k_lines[i]}\n")
