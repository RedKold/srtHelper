...
class Ui_SrtHelper(object):
    def setupUi(self, SrtHelper):
        ...
        self.selectSrtButton.setGeometry(QtCore.QRect(360, 30, 161, 23))
        ...
        self.selectDirecButton = QtWidgets.QPushButton(SrtHelper)
        self.selectDirecButton.setGeometry(QtCore.QRect(360, 70, 161, 23))
        self.selectDirecButton.setObjectName("selectDirecButton")
    ...
    def retranslateUi(self, SrtHelper):
        ...
        self.selectDirecButton.setText(_translate("SrtHelper", "选择字幕文件夹"))
